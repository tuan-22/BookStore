                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form">
                                        <form name='myform' action="adEditBook" method="Post" enctype="multipart/form-data" onsubmit="return validation()">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select name='cate' class="custom-select">
                                                            <c:forEach items="${listC}" var="o">
                                                                <c:if test="${book.cateID==o.id}"><option value="${o.id}" selected>${o.name}</option></c:if>
                                                                <c:if test="${book.cateID!=o.id}"><option value="${o.id}">${o.name}</option></c:if>
                                                            </c:forEach>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="sell" class="form-control" value="${book.buyPrice}"  required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div id="wap" class="basic-form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group mb-3">
                                                            <input name="author" type="text" class="form-control" value="${Author1.name}" required>
                                                ...
                                                <c:if test="${listSize>1}">
                                                    <c:forEach items="${listA}" var="o">
                                                        <div class="form-group row" >
                                                            ...
                                                            <div class="col-sm-10">
                                                                <div class="input-group mb-3">
                                                                    <input name="author" type="text" class="form-control" value="${o.name}" required>
                                                                    <div class="input-group-append"> 
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <textarea name="des" class="form-control h-150px" rows="4" id="comment" required>${book.description}</textarea>
                                                </div>
                                            </div>
