                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="addsellernav" style="margin-top: 10px"><button  class="btn btn-outline-dark" type="button">Add New Seller Account</button></a>
                                            ...
                                            <tbody>
                                                <c:forEach items="${listSeller}" var="o">
                                                    <tr>
                                                        ...
                                                        <td>${o.getPhone()}</td>
                                                        <td>${o.getEmail()}</td>
                                                        <c:if test="${o.getActionID()==1}">
                                                            <td><span class="badge badge-success px-2">Verified</span></td>
                                                        </c:if>
                                                        <c:if test="${o.getActionID()==3}">
                                                            <td><span class="badge badge-warning px-2">Waiting</span></td>
                                                        </c:if>
                                                        <td>
                                                            <a onclick='showMess(${o.getAccID()})' style="margin-left: 30px"  data-toggle="tooltip" data-placement="bottom" title="Remove to BlackList"><i   class="icon-close"></i></a></td>
                                                    </tr>
                                                </c:forEach>
        ...
        ***********************************-->
        ...
        <script>
                                                                ...
                                                                function showMess(id) {
                                                                    var option = confirm("Are you sure to add Seller have id = " + id + " to BlackList ?");
                                                                    if (option === true) {
                                                                        window.location.href = "addBlacklist?page=seller&id=" + id;
                                                                    }
                                                                }
        </script>
