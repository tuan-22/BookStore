            ...
            <div class="row">
                        ...
                        <ul class="widget-list">
                            <li><a>Contact us</a>
                                <small> 
                                    ...
                                    <br> <i class="icon-facebook-f"></i> My Nguyen
                                    <br> <i class="icon-google">mail</i> : tramygeo@gmail.com
                                    <br> <i class="icon-phone"></i> 0356152400
                                </small>
                            </li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        ...
                        <ul class="widget-list">
                            <li><a href="cusreturnmanagementnav">Returns</a></li>
                        </ul><!-- End .widget-list -->
                    </div><!-- End .widget -->
                </div><!-- End .col-sm-6 col-lg-3 -->
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        ...
                        <ul class="widget-list">
                                ...
                                <li><a href="cusorderhome">Track My Order</a></li>
                                <li><a href="editprofile">Change Profile Info</a></li>
                                <li><a href="cusChangeNav">Change Password</a></li>
                        </ul><!-- End .widget-list -->
                    </div><!-- End .widget -->
                </div><!-- End .col-sm-6 col-lg-3 -->
            </div><!-- End .row -->
