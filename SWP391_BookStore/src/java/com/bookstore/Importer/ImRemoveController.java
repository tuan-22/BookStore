 ...
 * @author tramy
 */
public class ImRemoveController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.delecompanyByID(id);
        request.setAttribute("check", "Delete the publish company that have id = "+id+ " sucessful!");
