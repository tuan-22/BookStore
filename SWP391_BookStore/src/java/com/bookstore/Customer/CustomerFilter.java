...
public class CustomerFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (account==null) {
            req.getRequestDispatcher("cuswarming").forward(request, response);
        
        }else if (!account.getRoleName().equals("customer")& account.getActionID()==2) {
                request.getRequestDispatcher("cuswarming").forward(request, response);
        }
