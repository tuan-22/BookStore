 ...
 * @author tramy
 */
public class CheckActionFilter implements Filter {
    ...
    public CheckActionFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckActionFilter:DoBeforeProcessing");
        }
...
//                Logger.getLogger(LoginController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckActionFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("CheckActionFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("CheckActionFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CheckActionFilter()");
        }
        StringBuffer sb = new StringBuffer("CheckActionFilter(");
