 ...
 * @author tramy
 */
public class DiscountCheckFilter implements Filter {
    ...
    public DiscountCheckFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("DiscountCheckFilter:DoBeforeProcessing");
        }
...
//                }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("DiscountCheckFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("DiscountCheckFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("DiscountCheckFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("DiscountCheckFilter()");
        }
        StringBuffer sb = new StringBuffer("DiscountCheckFilter(");
