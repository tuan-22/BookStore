 ...
 * @author tramy
 */
public class AdFeedCateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<FeedbackTitle> list = dAO.addtotalAndStar(cateID);
            ...
            request.setAttribute("select", cateID);

            request.getRequestDispatcher("adFeedCate.jsp").forward(request, response);
            }
        }
    }
