 ...
 * @author tramy
 */
public class SellerChangePassController extends HttpServlet {
            ...
            if (dePass.equals(dto.getPassword())) {
                if (newpass.equals(confimpass)) {
                    ...
                    try {
                        ...
                        Logger.getLogger(SellerChangePassController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    Account account=dao.getAccountByID(accID);
                    session.setAttribute("acc", account);
                    request.setAttribute("check", "Password update success!");
                    request.getRequestDispatcher("sellerChangePass.jsp").forward(request, response);
                } else {
