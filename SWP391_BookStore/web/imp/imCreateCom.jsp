                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Create Publish Company</h4>
                                    ...
                                    <div class="basic-form">
                                        <form action="imAddCompany" method="POST" onsubmit="return myfun()">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    <div class="basic-form">
                                                        <button type="submit" class="btn mb-1 btn-warning" ><span style="margin-left: 23px;margin-right: 22px">Create</span></button>
                                                    </div>
